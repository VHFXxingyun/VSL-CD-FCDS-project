...
Version 1.0 is the first complete milestone of this project.  
...
This version represents the first stage where the system is not only able to detect and track a target, but also to perform stable lock confirmation and automatic output triggering.
...
Image Error (dx, dy)
   ↓
Incremental Command Generation
   ↓
USB Serial Communication
   ↓
ESP32 Servo Control
   ↓
Stable Lock Trigger (OUT)
